<script lang="ts">
	...
	import { Home, Calendar, Users, Users2, ShieldCheck, X, Menu, ArrowLeft } from 'lucide-svelte';
	...
	const navItems = [
		...
		{ href: '/admin/caretakers', label: 'Cuidadores', icon: Users },
		...(data.userRole === 'root_admin'
			? [{ href: '/admin/users', label: 'Usuários', icon: Users2 }]
			: [])
	];
